...
#define CONFIG_APP_ESPNOW_DEBUG_MONITORED 1
...
#define CONFIG_ESPNOW_OTA_RETRANSMISSION_TIMES 10
#define CONFIG_ESPNOW_OTA_SEND_RETRY_COUNT 50
#define CONFIG_ESPNOW_OTA_SEND_FORWARD_TTL 1
